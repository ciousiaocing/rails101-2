...
puts "這個種子檔會自動建立一個帳號，並且創建20個groups，每個group各30個posts"

create_account = User.create([email: 'example@gamil.com', password: '12345678', password_confirmation: '12345678', name: '測試用帳號'])
